window.addEventListener("load", function () {
  ...
  var connectFourContainer = document.querySelector("#connect-four-container");
  // only load jquery once user starts hovering over game
  connectFourContainer.addEventListener("mouseover", function () {
    if (initialized === true) {
      return;
    }
    initialized = true;
    ...
    (function () {
      ...
      script.addEventListener("load", () => {
        ...
        //c alculate diagonal winning array
